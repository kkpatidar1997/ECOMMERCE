...
//                             case !category:
//                       return  res.status(500).send({error: 'categoryis required'})  
//                        case !quantity:
  ...
  export const getProductController=async(req,res)=>{
    try {
      ...
      res.status(500).send({
        success:false,
        error,
        message:"error while gwtting product"
      })
  ...
  export const getSingleProductController =async(req,res)=>{
    try {
      ...
      res.status(500).send({
        success:false,
        error,
        message:"error while gwtting single product"
      })
